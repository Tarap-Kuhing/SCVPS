...
#
wget -q -O /usr/local/bin/geosite.dat "https://raw.githubusercontent.com/Loyalsoldier/v2ray-rules-dat/release/geosite.dat"
wget -q -O /usr/local/bin/geoip.dat "https://raw.githubusercontent.com/Loyalsoldier/v2ray-rules-dat/release/geoip.dat"
...
wget -O sl-addgrpc "https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/grpc/sl-addgrpc.sh"
