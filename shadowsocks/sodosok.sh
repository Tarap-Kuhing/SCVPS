#!/bin/bash
#shadowsocks-libev obfs install by Tarap Kuhing
# ==========================================
# Color
RED='\033[0;31m'
NC='\033[0m'
...
# Link Hosting Kalian
"hhtps://github.com/Tarap-Kuhing/SCVPS/tree/main/shadowsocks"
...
cd /usr/bin
wget -O addss "https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/shadowsocks/addss.sh"
wget -O delss "https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/shadowsocks/delss.sh"
wget -O cekss "https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/shadowsocks/cekss.sh"
wget -O renewss "https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/shadowsocks/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
