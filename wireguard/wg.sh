...
# ==================================================
# Link Hosting Kalian
"http://github.com/Tarap-Kuhing/SCVPS/main/wireguard"
...
echo -e "${Info} Wireguard Script Mod By Tarap Kuhing"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
