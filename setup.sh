...
wget https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/SLDNS/install-sldns && chmod +x install-sldns && bash ./install-sldns
...
wget -O /etc/set.sh "https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/ssh/set.sh"
chmod +x /etc/set.sh
history -c
echo "1.2" > /home/ver
echo " "
...
wget https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/xray/ins-xray.sh && chmod +x ins-xray.sh && screen -S xray ./ins-xray.sh
#install ssh ovpn
wget https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh ./ssh-vpn.sh
#Install sstp
wget https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/sstp/sstp.sh && chmod +x sstp.sh && screen -S sstp ./sstp.sh
#install ssr
wget https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/ssr/ssr.sh && chmod +x ssr.sh && screen -S ssr ./ssr.sh
#
wget https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/shadowsocks/sodosok.sh && chmod +x sodosok.sh && screen -S shadowsocks ./sodosok.sh
#installwg
wget https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/wireguard/wg.sh && chmod +x wg.sh && screen -S wireguard ./wg.sh
#install L2TP
wget https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/ipsec/psec.sh && chmod +x ipsec.sh && screen -S ipsec ./ipsec.sh
#
wget https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
# Websocket
wget https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/websocket/edu.sh && chmod +x edu.sh && ./edu.sh
...
wget https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/ipsaya.sh && chmod +x ipsaya.sh
# install xray grpc
wget https://raw.githubusercontent.com/Tarap-Kuhing/SCVPS/main/grpc/sl-grpc.sh && chmod +x sl-grpc.sh && ./sl-grpc.sh
